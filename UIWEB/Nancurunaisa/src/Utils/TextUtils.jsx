import { ArrowLeftOutlined, EditOutlined, MoreOutlined, PlusOutlined } from "@ant-design/icons";
import { Button, Dropdown, Form, Image, Layout, PageHeader, Skeleton, Typography } from "antd";
...
export function FormPageHeader(props){
    ...
    return (<PageHeader onBack={()=>{Navigate(-1)}} style={{zIndex:"6"}} backIcon={ !ActionsProvider.isAdd?
...
export function FormAvName(props){
    ...
    return(
        ...
        <div style={{position:"absolute",top:"150px",zIndex:"6"}}>
          ...
          <Image src={avatar} style={{display:Loading ? "None":"" ,width:"120px",height:"120px",borderRadius:"50%",border:"5px solid white"}}/>
        </div>
